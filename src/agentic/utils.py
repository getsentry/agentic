        ...
        if node.type == "pair":
            ...
            if key not in valid_keys:
                ...
                while prev_sibling and (
                    ...
                    or prev_sibling.children[0].text[1:-1].decode("utf-8")
                    not in valid_keys
                ):
                ...
                if (
                    ...
                    parsed_json.append(
                        (
                            correct_key,
                            tree.root_node.text[start_byte:end_byte].decode("utf-8"),
                        )
                    )
            else:
    ...
    def decorator(func):
        ...
        def wrapped_func(*args, **kwargs):
            ...
            raise MaxTriesExceeded(
                ...
                f"Last exception: {exception_formatter(last_exception) if last_exception else 'None'}"
            ) from last_exception
